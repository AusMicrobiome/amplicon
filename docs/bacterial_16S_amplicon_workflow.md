# Bacterial 16S rRNA gene Amplicon Analysis Workflow
...
**A. Classify the seqs against 16S database:**
    ...
    mothur "#set.dir(modifynames=F); classify.seqs(fasta=plateID_all_16S.good_sorted_uniques_ZOTUtab_relabelled_MA0.fasta, reference=gg_13_8_99.fasta, taxonomy=gg_13_8_99.gg.tax, cutoff=60, probs=FALSE)"
...
6. DeSantis T.Z., Hugenholtz P., Larsen N., Rojas M., Brodie E.L., Keller K., Huber T., Dalevi D., Hu P., Andersen G.L.(2006) Greengenes, a Chimera-Checked 16S rRNA Gene Database and Workbench Compatible with ARB. Appl. Environ. Microbiol. 72(7): 5069-5072; DOI: 10.1128/AEM.03006-05
